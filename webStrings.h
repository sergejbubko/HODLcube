    ...
    "<div class='container'>"
      ...
      "<form action='/get' target='hidden-form' id='settingsForm'>"
        ...
        "<div class='mb-2'>"
          ...
          "</label>"
          "<div class='mb-2'>"
            "<input type='number' name='inputBuzzTickThresh' step='0.01' min='0' max='100' value='%INPUT_BUZZ_TICK_THRESH%' class='form-control' required>"
          "</div>"
        "</div>"
        ...
        "<div class='mb-2'>"
          ...
          "</label>"
          "<div class='mb-2'>"
            "<input type='number' name='inputBuzzCPThresh' step='0.1' min='0.1' value='%INPUT_BUZZ_CP_THRESH%' class='form-control' required>"
          "</div>"
        "</div>"
